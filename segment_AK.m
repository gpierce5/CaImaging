...
nam = 'file_00007_6frameAVGnormcorr.tif'; %'file_00001_6frameAVGnormcorr.tif';
sframe=1;						% user input: first frame to read (optional, default 1)
num2read=3000;					% user input: how many frames to read   (optional, default until the end)

Y = bigread2(nam,sframe,num2read); %,sframe,num2read);
...
tau = 6; %Most important for getting neurons, determines what size of ROIs it looks for              % std of gaussian kernel (size of neuron) 
...
save([nam(1:end-4) '_rois.mat'],'A2','P','A_or','Coor','options','C2','C_df','S2','b2','f2','nam','sframe','num2read')

%savejson('jmesh',json_file,'filename');        % optional save json file with component coordinates (requires matlab json library)

%save([nam(1:end-4) '.mat'],'-v7.3')

%% display components

%plot_components_GUI_AK(Yr,A_or,C_or,b2,f2,Cn,options)
